...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [CoreAiSystem](https://github.com/CoreAiSystem) open-source ecosystem.
...
The `dashboard` application is the web frontend for CoreAiSystem, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/CoreAiSystem/dashboard
cd dashboard
npm install
```
...
- **GitHub Issues:** [github.com/CoreAiSystem/issues](https://github.com/CoreAiSystem)
- **Discussions:** [github.com/CoreAiSystem/discussions](https://github.com/CoreAiSystem)
